...
class Matrix2D:
    ...
    def execute(global_parameters, local_parameters):
        ...
        if file_util.file_exists(network_path):
            ...
            layer = Convolution2D(2, 4, activation='relu', name='convolution_1', kernel_initializer=initializer)(layer)
            layer = Dropout(0.75, name='dropout_convolution_1')(layer)
            layer = Convolution2D(4, 4, activation='relu', name='convolution_2', kernel_initializer=initializer)(layer)
            layer = Dropout(0.75, name='dropout_convolution_2')(layer)
            layer = Convolution2D(8, 4, activation='relu', name='convolution_3',
                                  kernel_initializer=initializer)(layer)
            layer = Dropout(0.75, name='dropout_convolution_3')(layer)
            #layer = Convolution2D(16, 4, activation='relu', name='convolution_4',
            #                      kernel_initializer=initializer)(layer)
